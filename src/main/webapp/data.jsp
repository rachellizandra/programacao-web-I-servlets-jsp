...
<html>
    ...
    <body>
      <div class="container-md">
          ...
          <div class="mb-3 row">
            <label for="staticAno" class="col-md-2 col-form-label">Ano</label>
            <div class="col-md-10">
              <input type="text" readonly class="form-control-plaintext" id="staticAno" value="<%= request.getAttribute("ano") %>">
            </div>
          </div>
